...
class BeltExam(models.Model):
    ...
    coach = models.OneToOneField(Coach, on_delete=models.CASCADE, null=False, blank=False)
    ...
    sportClub = models.OneToOneField(SportsClub, on_delete=models.CASCADE, null=False, blank=False)
